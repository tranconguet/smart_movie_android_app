...
class SearchResultListAdapter(
...
) : ListAdapter<Result, SearchResultListAdapter.SearchResultViewHolder>(MovieDiffUtil()) {
    ...
    class SearchResultViewHolder(
        ...
        private val tvMovieName = view.findViewById<TextView>(R.id.tvSearchItemTitle)
        private val ivMovieImage = view.findViewById<ImageView>(R.id.ivSearchItemImage)
...
//            tvGenres.text = formatGenresToString(movie.genre_ids)
            ...
            val genres = movie.genre_ids.filter { id ->
            ...
            val rating = movie.vote_average.toFloat() / 2
            rbRatingBar.rating = rating

            val imageUrl = IMAGE_BASE_URL + movie.backdrop_path
